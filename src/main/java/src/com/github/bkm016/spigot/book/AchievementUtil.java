...
public final class AchievementUtil {
	...
	private static final EnumMap<Achievement, String> achievements = new EnumMap<Achievement, String>(Achievement.class) {/**
		 * 
		 */
		private static final long serialVersionUID = -75666260956817826L;
