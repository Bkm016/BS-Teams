...
public class Message {
    ...
    public static final String PLUGIN_RELOAD = "Admin.PluginReload";
    ...
    public static final String PLAYER_QUIT_TEAM_MEMBER = "Player.QuitTeamMember";
    public static final String PLAYER_PRIVATE_TEAM = "Player.PrivateTeam";
    ...
    public static final String PLAYER_INVITE_LIST_TO_PLAYER = "Player.InviteListToPlayer";
    public static final String PLAYER_JOIN_TO_lEADER = "Player.JoinToLeader";
    public static final String PLAYER_JOIN_TO_PLAYER = "Player.JoinToPlayer";
    public static final String PLAYER_JOIN_LIST_TO_LEADER = "Player.JoinListToLeader";
    public static final String PLAYER_ACCPET_TO_lEADER = "Player.AccpetToLeader";
    public static final String PLAYER_ACCPET_TO_PLAYER = "Player.AccpetToPlayer";
    public static final String PLAYER_NO_ACCPET_TO_PLAYER = "Player.NoAccpetToPlayer";

    public static final String INVENTORY_DROP_NAME = "Inventory.Drop.Name";
    public static final String INVENTORY_DROP_PAGE_DOWN = "Inventory.Drop.PageDown";
    public static final String INVENTORY_DROP_PAGE_UP = "Inventory.Drop.PageUp";
}
